...
class WodsControllerTest < ActionController::TestCase
  ...
  test "should create wod" do
    assert_difference('Wod.count') do
      post :create, wod: {  Name: @wod. Name, NumberOfDaysPerWeek: @wod.NumberOfDaysPerWeek, Repetitions: @wod.Repetitions, TimeAlotted: @wod.TimeAlotted, WeightAmount: @wod.WeightAmount }
    end
  ...
  test "should update wod" do
    put :update, id: @wod, wod: {  Name: @wod. Name, NumberOfDaysPerWeek: @wod.NumberOfDaysPerWeek, Repetitions: @wod.Repetitions, TimeAlotted: @wod.TimeAlotted, WeightAmount: @wod.WeightAmount }
    assert_redirected_to wod_path(assigns(:wod))
  end
